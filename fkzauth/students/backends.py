...
class StudentBackend(object):
    ...
    """ Authenticates a student using its email and school """
        ...
        try:
            student = Student.StudentManager.select_related('promotion__formation__school')
                                .get(forlife_schools__forlife=forlife)
                                .get(promotions__formation__school__pk=school_id)
